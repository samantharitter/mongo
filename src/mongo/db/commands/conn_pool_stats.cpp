...
public:
    ...
    bool run(OperationContext* txn,
        ...
        for (auto&& host : stats.statsByHost) {
        ...
        result.appendNumber("totalInUse", stats.totalInUse);
        result.appendNumber("totalAvailable", stats.totalAvailable);
        result.appendNumber("totalCreated", stats.totalCreated);
