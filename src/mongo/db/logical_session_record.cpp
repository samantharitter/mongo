...
const std::string kSessionIdFieldName = "lsid";
const std::string kLastUseFieldName = "lastUse";
const std::string kOwnerDocFieldName = "owner";
const std::string kOwnerNameFieldName = "user";
const std::string kOwnerIDFieldName = "userId";
