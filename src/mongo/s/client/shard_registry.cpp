...
void ShardRegistry::_backgroundReload() {
    Client::initThreadIfNotAlready("ShardRegistry-Reload");

    // Make an operation context.
    ServiceContext::UniqueOperationContext uniqueCtx{cc().makeOperationContext()};
