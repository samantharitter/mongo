...
public:
    ...
    /**
     * Call listen on sockets, then return. This method may only be called
     * after a successful call to setupSockets(). Returns true if successful,
     * false if an error occured.
     *
     * This method will wake up any threads blocked in waitUntilListening().
     */
    bool beginListening();
    ...
    /**
     * Blocks until beginListening() has been called on this instance and gotten far enough that
     * the listener is ready to receive incoming network requests.
     */
