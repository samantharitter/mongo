...
SSLPeerInfo TransportLayerManager::getX509PeerInfo(const SessionHandle& session) const {
...
void TransportLayerManager::registerTags(const SessionHandle& session) {
